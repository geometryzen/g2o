...
import { compose_2d_3x3_transform } from '../src/lib/utils/compose_2d_3x3_transform';
import { decompose_2d_3x3_matrix } from "../src/lib/utils/decompose_2d_3x3_matrix";
import { MatrixDecomposition } from "../src/lib/utils/MatrixDecomposition";
import { decompose_2d_3x3_matrix_wang } from "../src/lib/utils/decompose_2d_3x3_matrix_wang";
...
describe("decompose_2d_3x3_matrix", function () {
    ...
    it("compose_2d_3x3_transform", function () {
        ...
        compose_2d_3x3_transform({ x, y }, { x: sx, y: sy }, angle, skewX, skewY, m);
    ...
    it("decompose_2d_3x3_matrix", function () {
        ...
        expect(decomposition.rotation).toBeCloseTo(angle, numDigits);
    ...
    it("decompose_2d_3x3_matrix_wang", function () {
        ...
        expect(decomposition.translation[0]).toBe(x);
        expect(decomposition.translation[1]).toBe(y);
